...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    powershell -Command "&{"^
        ...
        "}"^
        "Invoke-WebRequest -UseBasicParsing '%DOWNLOAD_URL%' -OutFile '%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar'"^
        "}"
...
@REM be processed in this script. This is needed to keep whitespace in
@REM values , and is also a way to support additional options if needed.
...
if exist %WRAPPER_JAR% (
    ...
    echo MVN Wrapper Download failed with errorCode %ERRORLEVEL%
    exit /b %ERRORLEVEL%
)
